...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    LT(FN1,KC_CAPS), LGUI_T(KC_A), LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), KC_D, KC_H, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O), KC_QUOT, KC_ENT,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, LT(MOUSE, KC_SLSH), RSFT_T(KC_UP),
    KC_LCTL, KC_LGUI, KC_LALT, LT(FN1,KC_SPC), MO(MOUSE), LT(FN1,KC_LEFT), LT(FN2,KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_END,
    _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, _______, _______,
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, _______, _______, _______, _______, KC_INS, KC_DEL, _______,
 ...
 [MOUSE] = LAYOUT_60_ansi( /* MOUSE */
    ...
    _______, KC_WH_U, KC_WH_L, KC_MS_U, KC_WH_R,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_MS_BTN2, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_MS_BTN2, _______,
         _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, _______, _______, _______, _______,   _______, _______,    _______,
    KC_ACL2, KC_ACL1, KC_ACL0,                  KC_MS_BTN1,                                 _______, _______, _______, _______
)
};
