...
// ),
 ...
 [_BASE_LAYER] = LAYOUT( /* Base */
    ...
    LT(_FN1_LAYER,KC_CAPS), LGUI(KC_A), LALT(KC_R), LCTL(KC_S), LSFT(KC_T), KC_D, KC_H, RSFT(KC_N), RCTL(KC_E), RALT(KC_I), RGUI(KC_O), KC_QUOT, KC_ENT,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_UP),
    KC_LCTL, KC_LGUI, KC_LALT, LT(_FN1_LAYER,KC_SPC), MO(_MSE_LAYER), LT(_FN1_LAYER,KC_LEFT), LT(_FN2_LAYER,KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer _FN1_LAYER
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_FN2_LAYER] = LAYOUT( /* Base */
   ...
   /*
  * Mouse Layer _MSE_LAYER
  */
 [_MSE_LAYER] = LAYOUT( /* Base */
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
    _______, KC_WH_U, KC_WH_L, KC_MS_U, KC_WH_R,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_MS_BTN1, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_MS_BTN2, _______,
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, _______, _______, _______, _______, KC_INS, KC_DEL, _______,
    KC_ACL2, KC_ACL1, KC_ACL0, _______, _______, _______, _______, _______
)
};
